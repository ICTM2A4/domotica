                ...
                if(currentLightingStatus != MainScreenPanel.jlLightingStatus) {
                    ...
                    if (MainScreenPanel.jlLightingStatus) { // if lightingstatus is true = on
                        ...
                        try {
                            ...
                            databaseFunction.insertLoggingLightValue("logging","sensor_id","value","datetime","status",1, ldrValue, currentDateTime,1);
                            //.out.println("sent 1");
                        } catch (IOException e) {
                            e.printStackTrace();
                        }
                        ...
                        try {
                            ...
                            SimpleDateFormat format = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss") ;
                            String currentDateTime = format.format(date);
                            databaseFunction.insertLoggingLightValue("logging","sensor_id","value","datetime","status",1, ldrValue, currentDateTime,0);
